	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    .requestMatchers("/auth/**", "/roles", "/produtos/dto", "/categorias/dto", "/clientes/**" ,"/swagger-ui/**", "/v3/api-docs/**", "/upload/**","/enderecos", "/itemPedidos/**", "/pedidos/**").permitAll() //define as rotas publicas/abertas
