	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    .requestMatchers("/auth/**", "/enderecos", "/roles", "/produtos/dto", "/categorias/dto", "/clientes/**" ,"/swagger-ui/**", "/v3/api-docs/**", "/upload/**", "/itemPedidos/**", "/pedidos/**").permitAll() //define as rotas publicas/abertas
